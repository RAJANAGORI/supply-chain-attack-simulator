/**
 * Mock attacker server for Scenario 3: Compromised Package
 * Receives POST /collect payloads and exposes GET /captured-data for inspection.
 */
  ...
  if (req.method === 'POST' && req.url === '/collect') {
    ...
    req.on('end', () => {
      try {
        ...
        console.log('\n🎯 CAPTURED DATA (compromised-package):');
        ...
        captures.captures.push({
          ...
          attackType: 'compromised-package',
          data,
        });
        fs.writeFileSync(logFile, JSON.stringify(captures, null, 2));
...
server.listen(PORT, () => {
  console.log('🎭 Mock Attacker Server Started (Scenario 3)');
  console.log('─'.repeat(50));
