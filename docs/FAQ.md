...
1. Read [ZERO_TO_HERO.md](./ZERO_TO_HERO.md)
2. Run `./START_HERE.sh` or follow [SETUP.md](./SETUP.md)
...
| Doc | Purpose |
|-----|---------|
| [ZERO_TO_HERO.md](./ZERO_TO_HERO.md) | Short getting-started guide for your **first lab** |
