...
**First-time install?** Start with [Full-stack setup](../getting-started/FULL_STACK_SETUP.md) (Parts 1–3 cover SCAS, Elasticsearch, and Floci together). This guide is the cloud-track reference once the emulator is running.
