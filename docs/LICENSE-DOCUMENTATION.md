...
- Everything under [`documentation/`](documentation/) (guides, zero-to-hero walkthroughs, quick-reference cards, learning paths, teaching modules, catalogs, FAQ, architecture docs, and related Markdown)
- The published documentation site ([`docs/guide.html`](docs/guide.html) and symlinked Markdown served from [`docs/`](docs/))
- Original diagrams, sequence flows, curriculum structure, and instructor module cards authored for this project

## What this does not cover

**Software source code** (scenarios, scripts, detection tools, observability stack, mock servers, and other programmatic assets) is licensed under the **[MIT License](LICENSE)**, not this document.
...
For commercial training, white-label courses, or derivative documentation, contact the copyright holder via [GitHub](https://github.com/rajanagori).
