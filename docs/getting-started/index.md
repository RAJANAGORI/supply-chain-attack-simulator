...
|----------|-------------|
| [FULL_STACK_SETUP.md](./FULL_STACK_SETUP.md) | **Recommended workshop install** — SCAS + Elasticsearch/Kibana + Floci, step by step |
...
| [SETUP.md](./SETUP.md) | SCAS-only installation, environment configuration, and prerequisites |
